...
def process_one_image(image_path, clip_model, clip_preprocess, device, word_list, text_features, mask_predictor, output_path,
                      image_file):
...
if __name__ == "__main__":
    ...
    with tqdm(total=len(all_image_paths), desc="Generating COCA masks") as pbar:
        for image_path in all_image_paths:
            ...
            process_one_image(image_path, clip_model, clip_preprocess, device, word_list, text_features, mask_predictor, output_path,
                              image_file)
            end_time = time.time()
